...
面向 Android、Windows 的抖音内容提取客户端，以及运行于 Linux 的 Go 服务端。项目采用 Flutter + Go + SQLite + FFmpeg + 云端 ASR，当前进入 **M2 抖音解析**。
...
- M3-M7：尚未实施，详见[主设计文档](DouyinCapture_Product_Technical_Design.md)。
